...
import trash from '@icons/trash-can-regular.png';
...
const Configurador4 = () => {
  ...
  const { state, setConfig,fetchOrderData } = useContext(AppContext);
  ...
  useEffect(() => {
    console.log("Se ejecuta fetchOrderData (carga los carritos de compra)");
 ...
 // HELPER FUNCTIONS ============================================================
  ...
  const {setTieneBocinaReemplazo} = useContext(AppContext);
  const {setTerminaConfiguracion1} = useContext(AppContext);
  const {setMejoraAudio} = useContext(AppContext);
  const {setTieneBocinaOriginal} = useContext(AppContext);
  const {setTieneAmplificadorBajos} = useContext(AppContext);
  const {setTieneEcualizador} = useContext(AppContext);
  const {removeFromCartConf } = useContext(AppContext);
  ...
  const handleRemove  = (categoryIdConfigurador,id_categoria) => {  //7,14
    let APIDeleteAll2 = "";
    APIDeleteAll2 = APIDeleteAll.concat("9");
    let dataConfCaracteristicas = {
      orderType: 'configurador',
    ...
    let dataCaracteristicas1 = {
      ...
      switch(categoryIdConfigurador){
        ...
        case "8": //bases
          data = {orderId: 9,categoryId: 13,categoryIdConfigurador: 8}; //Borro bases
          useDeleteOrderItem(APIDelete,data);

        case "8": case "7": //arneses
          data = {orderId: 9,categoryId: 14,categoryIdConfigurador: 7}; //Borro arneses
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": // Adaptadores de antena
          data = {orderId: 9,categoryId: 15,categoryIdConfigurador: 2}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "3": // Adaptadores de impedancia
          data = {orderId: 9,categoryId: 27,categoryIdConfigurador: 3}; 
          console.log(data);
          console.log(APIDelete);
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3": case "11": // Bocina RD Borro bocinas y componentes
          data = {orderId: 9,categoryId: 16,categoryIdConfigurador: 11}; 
          useDeleteOrderItem(APIDelete,data);
          data = {orderId: 9,categoryId: 29,categoryIdConfigurador: 11}; 
          useDeleteOrderItem(APIDelete,data)
        case "8": case "7": case "2": case "3":  case "11": case "16": // Base Bocina RD
          data = {orderId: 9,categoryId: 28,categoryIdConfigurador: 16}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": //Bocina RT  Borro bocinas y componentes
          data = {orderId: 9,categoryId: 16,categoryIdConfigurador: 12}; 
          useDeleteOrderItem(APIDelete,data);
          data = {orderId: 9,categoryId: 29,categoryIdConfigurador: 12}; 
          useDeleteOrderItem(APIDelete,data)
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": //Base Bocina RT
          data = {orderId: 9,categoryId: 28,categoryIdConfigurador: 17}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": //Amplificador de voz
          data = {orderId: 9,categoryId: 17,categoryIdConfigurador: 5}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": //Bocina PD  Borro bocinas y componentes
          data = {orderId: 9,categoryId: 16,categoryIdConfigurador: 9}; 
          useDeleteOrderItem(APIDelete,data);
          data = {orderId: 9,categoryId: 29,categoryIdConfigurador: 9}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": //Base BPD
          data = {orderId: 9,categoryId: 28,categoryIdConfigurador: 14}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": //Bocina PT  Borro bocinas y componentes
          data = {orderId: 9,categoryId: 16,categoryIdConfigurador: 10}; 
          useDeleteOrderItem(APIDelete,data);
          data = {orderId: 9,categoryId: 29,categoryIdConfigurador: 10}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": //Base BPT
          data = {orderId: 9,categoryId: 28,categoryIdConfigurador: 15}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": case "6":  //Amplificador Woofer
          data = {orderId: 9,categoryId: 17,categoryIdConfigurador: 6}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": case "4":  //Amplificador 3 en 1
          data = {orderId: 9,categoryId: 38,categoryIdConfigurador: 4}; 
          useDeleteOrderItem(APIDelete,data);
        ...
        case "13": case "21": case "4":  //Kit de cables
          data = {orderId: 9,categoryId: 25,categoryIdConfigurador: 21}; 
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": case "6": case "26":
        case "13": case "21": case "18":  //Ecualizador
          data = {orderId: 9,categoryId: 20,categoryIdConfigurador: 18}; 
          useDeleteOrderItem(APIDelete,data);        
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": case "6": case "26":
        case "13": case "21": case "18": case "19": //Epicentro
          data = {orderId: 9,categoryId: 23,categoryIdConfigurador: 19};
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": case "6": case "26":
        case "13": case "21": case "18": case "19": case "23": //Procesador
          data = {orderId: 9,categoryId: 24,categoryIdConfigurador: 23};
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": case "6": case "26":
        case "13": case "21": case "18": case "19": case "23": case "25": //Tweeters
          data = {orderId: 9,categoryId: 19,categoryIdConfigurador: 25};
          useDeleteOrderItem(APIDelete,data);
        case "8": case "7": case "2": case "3":  case "11": case "16": case "12": case "17": case "5": case "9": case "14": case "10": case "15": case "6": case "26":
        case "13": case "21": case "18": case "19": case "23": case "25": case "1": case "4":  //Accesorios
          data = {orderId: 9,categoryId: 26,categoryIdConfigurador: 1};
          useDeleteOrderItem(APIDelete,data);
        break
        default:
          data = {
  ...
  //variables para ver  las condiciones de si se expande o no
  const expandEstereo =
  ...
  const expandAdaptadores = state.arnesC.SKU != undefined && 
  ...
  const calzaBocinaPD = (state.bocinaPremiumDelanteraC.SKU != undefined && state.calzaBocinaPremiumDelanteraC.length === 0) || 
  ...
  const expandAccesorios =   (state.tweeterC.SKU != undefined && state.accesorioC.length === 0) || 
    ...
    (state.amplificador3en1C.id != undefined && state.kitCablesC.id != undefined && state.accesorioC.length === 0) || 
    (state.amplificador3en1C.id != undefined && state.kitCablesC === 'N/A' && state.accesorioC.length === 0);
  //https://www.freakyjolly.com/react-material-ui-accordion-tabs-tutorial-with-example/  
  //console.log(activeOrder);
  if (loading) { 
    return (
      <Box className="Configurador_Form">
        <CircularProgress /> {/* Display a circular progress indicator while loading */}
      </Box>
    );
  }  
  return (
      <Box className="Configurador_Form">
        <Stack alignItems="center" direction="column"> 
          <Box className="configurador_header">
            <Box sx={{alignItems:"left"}}><Typography sx={{fontWeight: 600}} variant="h6">Configurador de Auto </Typography></Box>
            <Box>
          ...
          <Box className="configurador_tuAuto">
            <Box className="configurador_tuAuto1">
              ...
              <Typography sx={{paddingLeft:"6px"}}>{activeOrder.marca} {activeOrder.modelo} {activeOrder.anio}</Typography>
            </Box>
            <Box className="configurador_tuAuto2">
              <Typography sx={{paddingLeft:"6px"}}>Dines: {activeOrder.dines} Configuracion: {activeOrder.tipoConfiguracion}</Typography>
            </Box>            
          </Box>
{
//------------------------------------------------------ESTEREO--------------------------------------------------------------
          ...
          disabled = {activeOrder.tieneEstereoOriginalC === 'si' || activeOrder.tieneEstereoTipoOriginalC === true}
          onChange={handleChange('panel1')} >
            ...
            <AccordionDetails>   
              {(expanded === 'panel1' || expandEstereo) && (       
                <ConfiguradorCategoria category="20" config={activeOrder} value={valor} value2= {valor2} optional="false" carFeatures={caracteristicas}/>
              )}
            </AccordionDetails>
          </Accordion>
{
          ...
          disabled = {state.estereoC.length === 0} id="accordion_base">{/* disabled={enabledBase}*/}
           <Box className="configurador-accordionSummary">
            ...
            {(expandBases || expanded === 'panel2') && (     
              <ConfiguradorCategoria category="8" config={activeOrder} value={valor} value2= {valor2} estereo={state.estereoC.modelo} optional="false" carFeatures={caracteristicas}/>
            )}
            </AccordionDetails>
          </Accordion>
{
//------------------------------------------------------ARNESES--------------------------------------------------------------
          ...
          disabled = {state.baseC.length === 0}>
            ...
            <Box className="configurador-button-borrar">
              {(state.arnesC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('7','14')}/>:  ''
              }
              </Box>
            </Box>
            <AccordionDetails>
            {(expandArneses || expanded === 'panel3') && ( 
              <ConfiguradorCategoria category="7" config="Modelo" value={arnesHF} optional="false" carFeatures={caracteristicas}/>
            )}
            </AccordionDetails>
          </Accordion>
{
//------------------------------------------------------ADAPTADORES--------------------------------------------------------------
          ...
          disabled = {state.arnesC.length === 0}>
            ...
            <AccordionSummary className="configurador-accordion-header" aria-controls="panel4-content" id="panel4d-header">
              ...
              <Box className="configurador-button-borrar">
              {(state.adaptadorC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('2','15')} />:  ''
              }
              </Box>
            </Box>
            <AccordionDetails>
            { (expanded === 'panel4' || expandAdaptadores) && ( 
              <ConfiguradorCategoria category="2" config="Modelo" value={adaptadorAntenaHF} optional="false" carFeatures={caracteristicas}/>
            )}
            </AccordionDetails>
          </Accordion>
...
disabled = {state.tieneEstereoOriginalC!= 'si'}>
  ...
  <AccordionSummary className="configurador-accordion-header" aria-controls="panel4-content" id="panel4d-header">
    ...
    <Box className="configurador-button-borrar">
    {(state.adaptadorImpedanciaC.length != 0) ?
      <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('3','27')} />:  ''
    }
    </Box>
  </Box>
  <AccordionDetails>    
  {(expandAdaptadoresImpedancia || expanded === 'panel23') && ( 
    <ConfiguradorCategoria category="3" config="Modelo" value={adaptadorAntenaHF} optional="false" carFeatures={caracteristicas}/>
  )}
  </AccordionDetails>
</Accordion>
{
          ...
          <Box className="configurador-accordionSummary">
            ...
            <Box className="configurador-button-borrar">
              {(state.calzaBocinaReemplazoDelanteraC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('16','28')} />:  ''
              }
            </Box>
          </Box>
          <AccordionDetails>
          {(expandBaseBocinaRD || expanded === 'panel6') && (
            <ConfiguradorCategoria category="16" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
          )}
          </AccordionDetails>
        </Accordion>
{
          ...
          <Box className="configurador-accordionSummary">
            ...
            <Box className="configurador-button-borrar">
              {(state.bocinaReemplazoTraseraC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('12','16')}/>:  ''
              }
            </Box>
          </Box>
          <AccordionDetails>
          ...
          <Box className="configurador-accordionSummary">
            ...
            <Box className="configurador-button-borrar">
              {(state.calzaBocinaReemplazoTraseraC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('17','28')} />:  ''
              }
            </Box>
          </Box>
          <AccordionDetails>
...
//------------------------------------------------------TERMINAR CONFIGURACION 1--------------------------------------------------------------
        ...
        disabled = {state.calzaBocinaReemplazoTraseraC.length === 0 && state.calzaBocinaReemplazoTraseraC.length === 0}>
           <Box className="configurador-accordionSummary">
            ...
            {
                (state.terminaConfiguracion1.length === 0) 
                && 
                <AccordionDetails>
                  <Stack alignItems="center" direction="column" sx={{marginTop:"10px"}}>
          ...
          <Box className="configurador-accordionSummary">
            ...
            <Box className="configurador-button-borrar">
              {(state.amplificadorC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('5')} />:  ''
              }
            </Box>
          </Box>
          <AccordionDetails>
        ...
        disabled = {state.amplificadorC.length === 0 || state.tieneBocinaOriginal === 'si'}>
          ...
          <Box className="configurador-button-borrar">
              {(state.bocinaPremiumDelanteraC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('9','16')}/>:  ''
              }
              </Box>
            </Box>
          <AccordionDetails>
...
//------------------------------------------------------CALZAS BOCINA PREMIUM DELANTERA--------------------------------------------------------------
      ...
      <Accordion expanded={(calzaBocinaPD || expanded === 'panel12')} onChange={handleChange('panel12')} 
          ...
          <Box className="configurador-accordionSummary">
            ...
            <Box className="configurador-button-borrar">
              {(state.calzaBocinaPremiumDelanteraC.length != 0) ?
                <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('14','28')} />:  ''
              }
            </Box>
          </Box>
          <AccordionDetails>
          {(calzaBocinaPD || expanded === 'panel12') && (
            <ConfiguradorCategoria category="14" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
          )}
          </AccordionDetails>
        </Accordion>
{
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.bocinaPremiumTraseraC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('10','16')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandBocinaPT || expanded === 'panel13') && (
          <ConfiguradorCategoria category="10" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
{
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.calzaBocinaPremiumTraseraC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('15','28')} />:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandCalzaBocinaPT || expanded === 'panel14') && (
        <ConfiguradorCategoria category="15" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
{
    ...
    <Accordion expanded={(expandedAmplificadorWoofer || expanded === 'panel15')} onChange={handleChange('panel15')} 
      ...
      <Box className="configurador-button-borrar">
          {(state.amplificadorWooferC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('6','17')}/>:  ''
          }
          </Box>
        </Box>
      <AccordionDetails>
        {
            ...
            :
              ...
              &&
              <ConfiguradorCategoria category="6" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>          
          }
      </AccordionDetails>
    </Accordion>
{
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.amplificador3en1C.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('4','38')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandAmplificador3en1 || expanded === 'panel24') && (
          <ConfiguradorCategoria category="4" config="Modelo" value={unDinHF} optional="false" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
{
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.cajonAcusticoC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('13','7')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandCajonAcustico || expanded === 'panel16') && (
        <ConfiguradorCategoria category="13" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
{
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.wooferC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('26','21')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandWoofer || expanded === 'panel17') && (
          <ConfiguradorCategoria category="26" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.kitCablesC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('21','25')} />:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandKitCables || expanded === 'panel18') && (
        <ConfiguradorCategoria category="21" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
    ...
    <Accordion expanded={(expandEcualizador || expanded === 'panel18a')} onChange={handleChange('panel18a')} 
      ...
      <Box className="configurador-button-borrar">
          {(state.ecualizadorC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('18','20')}/>:  ''
          }
          </Box>
        </Box>
      <AccordionDetails>
        {
            ...
            :
              ...
              &&
              <ConfiguradorCategoria category="18" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
          }
      </AccordionDetails>
    </Accordion>
{
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.epicentroC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('19','23')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandEpicentro || expanded === 'panel19') && (
        <ConfiguradorCategoria category="19" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.procesadorC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('23','24')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandProcesador || expanded === 'panel20') && (
          <ConfiguradorCategoria category="23" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
{
      ...
      <Box className="configurador-accordionSummary">
        ...
        <Box className="configurador-button-borrar">
          {(state.tweeterC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('25','19')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
...
//------------------------------------------------------ACCESORIOS --------------------------------------------------------------
    ...
    disabled = {
      !((state.tweeterC.SKU != undefined || state.tweeterC === 'N/A') || ((state.kitCablesC.id != undefined || state.kitCablesC === 'N/A') && state.amplificador3en1C.id != undefined))}>
      <Box className="configurador-accordionSummary">
        <AccordionSummary className="configurador-accordion-header" aria-controls="panel21d-content" id="panel21d-header">
        ...
        <Box className="configurador-button-borrar">
          {(state.accesorioC.length != 0) ?
            <img className = "trashCanConf" src={trash} alt="close"  onClick={() => handleRemove('1','26')}/>:  ''
          }
        </Box>
      </Box>
      <AccordionDetails>
      {(expandAccesorios || expanded === 'panel22') && (
        <ConfiguradorCategoria category="1" config="Modelo" value={unDinHF} optional="true" carFeatures={caracteristicas}/>
      )}
      </AccordionDetails>
    </Accordion>
        </Stack>
          ...
          <Box className='nextButton_container'>
                <Button  onClick={handleSubmit}  
                  ...
                  className={
                    ...
                    state.accesorioC.length != 0 ||
                    state.tieneEcualizador == "no"
                    )? 'primary-basic' : 'primary-basic_disabled' } >Siguiente paso</Button>
          </Box>
